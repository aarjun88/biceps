...
namespace Bicep.Core.Emit
{
    public class ResourceDependencyVisitor : SyntaxVisitor
    {
        ...
        /// <param name="faultTolerant">Whether to suppress errors like unbounded declartions. Only set to true when calling from <see cref="ResourceDependencyVisitor"/>.</param>
        /// <returns></returns>
